...
The generator website is deployed automatically through GitHub Pages. For one-click file generation, run the local bridge described in [the generator guide](dragon_generator/website/README.md).
