...
const FLIGHT_SPEED_TAGS = [
	"dragonmounts2:flight_speed_slow",
	"dragonmounts2:flight_speed_default",
];
...
export function setPlayerDragonSpeed(player, value) {
	...
	try {
		...
		console.error(`[DragonMounts2] Could not save flight speed: ${error?.message ?? error}`);
	}
}
