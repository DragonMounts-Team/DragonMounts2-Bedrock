...
system.beforeEvents.startup.subscribe(({ itemComponentRegistry }) => {
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:dragon_flute",
    DragonFlute,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:dragon_scepter",
    DragonScepter,
  );
  itemComponentRegistry.registerCustomComponent(
  ...
  itemComponentRegistry.registerCustomComponent(
    ...
    Aetherdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:storm_dragon_scale_effects",
    Stormdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:fire_dragon_scale_effects",
    Firedragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:ice_dragon_scale_effects",
    Icedragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:forest_dragon_scale_effects",
    Forestdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:ender_dragon_scale_effects",
    Enderdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:dark_dragon_scale_effects",
    Darkdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:light_dragon_scale_effects",
    Lightdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:enchanted_dragon_scale_effects",
    Enchanteddragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:water_dragon_scale_effects",
    Waterdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:moonlight_dragon_scale_effects",
    Moonlightdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:sculk_dragon_scale_effects",
    Sculkdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:terra_dragon_scale_effects",
    Terradragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:zombie_dragon_scale_effects",
    Zombiedragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:sunlight_dragon_scale_effects",
    Sunlightdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:nether_dragon_scale_effects",
    Netherdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:wither_dragon_scale_effects",
    Witherdragon_scaleEffects,
  );
  itemComponentRegistry.registerCustomComponent(
    "dragonmounts2:fire_dragon_scale_lore",
    Firedragon_scaleLore,
  );
  itemComponentRegistry.registerCustomComponent(
